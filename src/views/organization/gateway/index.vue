    ...
    >
      ...
      >
        <template slot-scope="scope">
          <span>
            <li
              v-for="(predicates, index) in scope.row.predicates"
              :key="index"
            >
              {{ predicates.name }}
              <ul>
                <li
                  v-for="(args, _index) in predicates.args"
                  :key="_index"
                >
                  {{ args }}
                </li>
      ...
      >
        <template slot-scope="scope">
          <span>
            <li
              v-for="(filters,index) in scope.row.filters"
              :key="index"
            >
              {{ filters.name }}
              <ul>
                <li
                  v-for="(args,_index) in filters.args"
                  :key="_index"
                >
                  {{ args }}
                </li>
    ...
    >
      ...
      >
        ...
        >
          <el-input
            v-model="temp.uri"
            placeholder="请输入uri路径,如:lb://或http://"
          />
        </el-form-item>
        <!--predicates输入框-->
        <el-form-item
